...
public static class SeekerData
{
    ...
    public static void  Initialization(Seeker2 seeker)
    {
        //Find Path Trigger
        _FindPathTrigger.Add(PathTrigger.MouseInput, new MouseInputTrigger(seeker.MouseSide, seeker.LayerMask, Camera.main, null));
        _FindPathTrigger.Add(PathTrigger.MousePosition, new MousePositionTrigger(seeker.LayerMask, Camera.main, null));
        _FindPathTrigger.Add(PathTrigger.TargetPosition, new TargetPositionTrigger(seeker.SeekerTarget));
